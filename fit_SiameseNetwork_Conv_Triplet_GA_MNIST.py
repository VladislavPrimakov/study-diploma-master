...
def main():
    parser = argparse.ArgumentParser(description="Siamese Network with Triplet and GA based on ConvNet")
    ...
    model_name = "SiameseNetwork_Conv_Triplet_GA_MNIST"
    model = EmbeddingNet(1)
    loss_fn = TripletLoss(useGA=True, reduction="sum")
